...
%  \item \textbf{Programming Language:} Objected-Oriented Design with JAVA, Web Design with HTML, CSS, JavaScript, Statistic Analysis with Python, R. Documentation with \LaTeX.
